...
function setup() {
  var isMobile = /iPhone | iPad | Android | Linux/i.test(navigator.userAgent)
 ...
 if (isMobile){
  ...
  button1.position(20,90);
  button1.size(50,50);
  button1.mouseClicked(drop2);

  button2 = createImg('cut_btn.png');
  button2.position(350,110);
  button2.size(50,50);
  ...
  rope1 = new Rope(7,{x:350,y:110});
  rope2 = new Rope(7,{x:20,y:90});
